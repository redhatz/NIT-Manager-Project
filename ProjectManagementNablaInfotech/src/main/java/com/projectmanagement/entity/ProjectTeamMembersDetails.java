...
public class ProjectTeamMembersDetails   {
  ...
  public ProjectTeamMembersDetails employeeFullName(String employeeFullName) {
  ...
  public ProjectTeamMembersDetails firstName(String firstName) {
  ...
  public ProjectTeamMembersDetails middleName(String middleName) {
  ...
  public ProjectTeamMembersDetails lastName(String lastName) {
  ...
  public ProjectTeamMembersDetails mobileNumber(String mobileNumber) {
  ...
  public ProjectTeamMembersDetails position(PositionEnum position) {
  ...
  public ProjectTeamMembersDetails yearsOfExperience(String yearsOfExperience) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProjectTeamMembersDetails projectTeamDetailsRequestBodyTeamMembersDetails = (ProjectTeamMembersDetails) o;
