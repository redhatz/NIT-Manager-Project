									...
									<li class="nav-item dropdown justify-content-end"><a
										...
										<div class="dropdown-menu">
											<a class="nav-link" data-toggle="tab" href="#Project-Working"
												role="tab">Working</a> <a class="nav-link" data-toggle="tab"
												href="#Project-Completed" role="tab">Completed</a> <a
												class="nav-link" data-toggle="tab" href="#Project-Pending"
												role="tab">Pending</a>
										</div></li>
								</ul>
							</div>
						...
						<div class="tab-pane fade show active" id="ProjectDetails"
							...
							<div class="row">
								<c:forEach items="${projectDetailsList }" var="projectDetails">
											...
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-7 py-1">
														<strong><a class="btn btn-primary"
															style="background-color: #3b5998" role="button"
															data-toggle="modal" href="#technologyDetails"
													...
													<div class="col-7 py-1">
														<strong><a class="btn btn-primary"
															...
															data-toggle="modal" href="#teamDetails" type="button"><i
														...
														<div class="avatar-list avatar-list-stacked">
															<c:forEach
																...
																<img class="avatar avatar-sm"
																	src="https://ui-avatars.com/api/?name=${teamMembersDetails.firstName }+${teamMembersDetails.lastName }&background=random"
																	data-toggle="tooltip"
											...
											<div class="row card-footer">
												<div class="col-4">
													<button class="continue-application" data-toggle="modal"
														href="#updateDetails" type="button">
														<div>
									...
									<div id="technologyDetails" class="modal">
															...
															<form>
																...
																<div class="form-group">
																	<label for="framework">Framework:</label> <input
																		type="text" class="form-control" id="framework"
																...
																<div class="form-group">
																	<label for="project-type">Project Type:</label> <input
																		...
																		value=${projectDetails.technology.projectType
																					}
																		readonly>
																</div>
																<c:forEach
																	items="${projectDetails.technology.database }"
																	var="projectDetailsDatabase">
																	<div class="form-group">
																		<label for="database-used">Database Used:</label> <input
																			type="text" class="form-control" id="projectType"
																			value=${projectDetailsDatabase.databaseName
																						}
																			readonly>
									...
									<div class="modal fade" id="updateDetails" tabindex="-1"
										role="dialog" aria-hidden="true">
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content">

												<div class="modal-body">
													<div class="container" style="background-color: #5252d4;">
														<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
															<div class="wrapper wrapper--w790">
																<div class="card card-5">
																	<div class="card-heading">
																		<h2 class="titleUpdateDetails">Update Project
																			Details</h2>
																	</div>
																	...
																	<form action="/updateProjectDetails" method="POST"
																		...
																		<div class="card-body">
																				...
																				<div class="value">
																					<div class="input-group">
																						<textarea id="projectDescription"
																							name="projectDescription" rows="4" cols="67">${projectDetails.projectDescription }</textarea>
																					</div>
																				</div>
																			</div>
																			<div class="form-row-update">
																				<div class="name">Project Owner</div>
																				<div class="value">
																					<div class="input-group">
																						<input class="input--style-5" type="textarea"
																							name="projectOwner" id="projectOwner"
																			...
																			<div class="form-row-update">
																				<div class="name">Modified Date</div>
																				<div class="value">
																					<div class="input-group">
																						<input class="input--style-5" type="text"
																							name="modifiedDate" id="modifiedDate"
																							value="${projectDetails.modifiedDate }"
																							readonly="readonly">
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-row-update">
																				<div class="name">Programming Language</div>
																				<div class="value">
																					<div class="input-group">
																						<input class="input--style-5" type="text"
																			...
																			<div class="form-row-update">
																				<div class="name">Project Leader</div>
																				<div class="value">
																					<div class="input-group">
																						<input class="input--style-5" type="text"
																							name="projectLeader" id="projectLeader"
																			...
																			<c:forEach
																				...
																				<div class="form-row-update">
																					<div class="name">Employee Full Name</div>
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																					...
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																								...
																								value="${teamMembersDetails.firstName }">
																						</div>
																					</div>
																				</div>
																				<div class="form-row-update">
																					...
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																								...
																								value="${teamMembersDetails.middleName }">
																						</div>
																					</div>
																				</div>
																				<div class="form-row-update">
																					...
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																								...
																								value="${teamMembersDetails.lastName }">
																						</div>
																					</div>
																				</div>
																					...
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																								...
																								value="${teamMembersDetails.position }">
																						</div>
																					</div>
																				</div>
																					...
																					<div class="value">
																						<div class="input-group">
																							<input class="input--style-5" type="text"
																								...
																								value="${teamMembersDetails.yearsOfExperience }">
																						</div>
																					</div>
																				</div>
																			</c:forEach>
																			...
																			<div class="row">
																				<div class="col-6">
																					<button type="submit"
																						...
																						data-mdb-toggle="button" autocomplete="off">Update</button>
																				</div>

																				<div class="col-6">
																					<button class="btn btn-warning btn-lg active"
																						data-mdb-toggle="button" autocomplete="off"
									...
									<div class="modal fade" id="teamDetails" tabindex="-1"
										role="dialog" aria-hidden="true">
														...
														<div class="container"
															...
															<div class="card text-white bg-info"
																...
																<div class="card-body">
																	<form>
																		<div class="form-group">
																			<label for="employeeFullName">Employee Full
																				Name:</label> <input type="text" class="form-control"
																				id="employeeFullName"
																				value="${projectTeamMembersDetails.employeeFullName }"
																				readonly>
																		</div>
																		<div class="form-group">
																			<label for="firstName">First Name:</label> <input
																				type="text" class="form-control" id="firstName"
																				value=${projectTeamMembersDetails.firstName
																							}
																				readonly>
																		</div>
																		<div class="form-group">
																			<label for="middleName">Middle Name:</label> <input
																				...
																				value=${projectTeamMembersDetails.middleName
																							}
																				readonly>
																		</div>
																		<div class="form-group">
																			<label for="lastName">Last Name:</label> <input
																				...
																				value=${projectTeamMembersDetails.lastName
																							}
																				readonly>
																		</div>
																		<div class="form-group">
																			<label for="employeePosition">Employee
																				Position:</label> <input type="text" class="form-control"
																				id="employeePosition"
																				value=${projectTeamMembersDetails.position
																							}
																				readonly>
																		</div>
																		<div class="form-group">
																			<label for="yearsOfExperience">Years Of
																				Experience:</label> <input type="text" class="form-control"
																				id="yearsOfExperience"
																				value=${projectTeamMembersDetails.yearsOfExperience
																							}
																				readonly>
																		</div>
																	</form>
								...
								<c:forEach items="${projectDetailsList }" var="projectDetails">
									<c:if test="${projectDetails.status == 'WORKING'}">
										<div class="col-lg-6 col-md-12">
											<div class="card">
												<div class="card-header">
													<h3 class="card-title">${projectDetails.projectName }
													</h3>
													<div class="card-options">
														<label class="custom-switch m-0"> <input
															type="checkbox" value="1" class="custom-switch-input"
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-7 py-1">
															${projectDetails.projectOwner }</div>
														<div class="col-5 py-1">
															<strong>Start Date:</strong>
														</div>
														<div class="col-7 py-1">${projectDetails.startDate }
								...
								<fieldset>
									...
									<div class="TeamDetails">
										...
										<label for="cars">Choose project Team:</label> <select
											id="ProjectTeamId" name="ProjectTeamId">
											<c:forEach var="item" items="${teamDetailsList}">
												<option value="${item.teamId}">${item.teamId}
